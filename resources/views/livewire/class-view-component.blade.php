<div class="bg-gray-100 px-8 py-4">
    ...
    <div class="mt-4 ml-8 flex flex-col justify-start">
        ...
        @if(count($current_path_contents['images']))
            <div class="mt-6">
                <div class="flex flex-row items-center gap-x-2">
                    <div class="text-lg font-semibold">Images ({{ count($current_path_contents['images']) }})</div>
                    <div class="font-light text-gray-700">Having images here indicates that they've not yet been processed</div>
                </div>
        ...
        @else
            <div class="mt-6 text-lg font-semibold">No images in this directory</div>
        @endif
    </div>
</div>
