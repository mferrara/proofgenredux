        ...
        <div class="flex flex-row justify-between items-start gap-x-8">
            <div class="w-1/2">
                @if(count($current_path_directories) === 0)
                    <div class="text-lg font-semibold">No directories in this class</div>
                    <div class="p-2 font-light text-gray-700">This indicates that we've yet to import any images to this class.</div>
                @else
                    ...
                    <div class="mt-6">
                        ...
                        <div class="flex flex-col justify-start">
                            @foreach($images_pending_processing as $image)
                                ...
                                @endphp
                                <div class="pl-4 flex flex-row justify-between items-center gap-x-2">
                                    <div class="flex flex-row items-center gap-x-2">
                                    ...
                                    <div>
                                        <button class="px-1 py-0.5 text-xs font-semibold bg-gray-200 text-gray-800 rounded-sm border border-gray-300 hover:bg-gray-300 hover:text-gray-800 hover:border-gray-400"
                                                wire:click="processImage('{{ $image->path() }}')"
                                        >Import</button>
                                    </div>
                                </div>
                            @endforeach
