...
| [Operating Proofgen at a show](OPERATING.md) | For an agent (or person) helping the photographer: priorities, how the system works, the status/import/upload commands, "handle all pending classes", troubleshooting, what never to do |
