    ...
    public function enhance(string $imagePath, string $method, array $parameters = []): InterventionImage
    {
        ...
        switch ($method) {
            ...
            case 'advanced_tone_mapping':
                // For backward compatibility, both names work
                $lowPercentile = $parameters['tone_mapping_percentile_low'] ?? config('proofgen.tone_mapping_percentile_low', 0.1);
                $highPercentile = $parameters['tone_mapping_percentile_high'] ?? config('proofgen.tone_mapping_percentile_high', 99.9);
