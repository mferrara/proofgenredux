...
class RsyncCommandBuilder
{
     ...
     */
    public static function argv(string $localSource, string $remoteBase, string $remoteSubdir, bool $dryRun = false): array
    {
        ...
        $port = (int) config('proofgen.sftp.port', 0);
    ...
    {
        return implode(' ', array_map('escapeshellarg', self::argv($localSource, $remoteBase, $remoteSubdir, $dryRun)));
    }
